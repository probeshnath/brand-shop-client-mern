        ...
        <div>
            ...
            <div className="hero min-h-screen" style={{ backgroundImage: 'url(https://i.ibb.co/zhzP25h/latest-trends-in-the-automotive-industry.png)' }}>
                ...
                <div className="hero-content justify-left  text-left text-neutral-content">
                    <div className="max-w-6xl mx-auto flex pt-10 flex-col flex-col-reverse md:flex-row  justify-between items-center">
                        <div className='md:w-1/2'>
                            <h1 className="mb-5 text-3xl md:text-6xl font-bold " data-aos="fade-left">Welcome to <br /> <span className='text-red-700'>STAR automotive </span></h1>
